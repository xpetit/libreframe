...
package body TestApi_Cfg is
   ...
   begin
      ...
      Log.Info ("Default name creation (prog name + .cfg)");
      ...
      if Cfg.Open then
         ...
         Log.Info ("Get Parameter_11: " &
                    Cfg.Get ("Section_1", "Parameter_11"));
         Log.Info ("Get Parameter_21: " &
                    Cfg.Get ("Section_2", "Parameter_21"));
         Log.Info ("Get Parameter_31: " &
      ...
      Log.Info ("Create with a custom name (custom.ini)");
      Log.Info ("with a more complex scheme (see test.adb)");
      ...
      if Cfg.Open ("custom.ini") then
         ...
         if Cfg.Open ("custom.ini") then
            ...
            Log.Info ("Get Parameter_12: " &
                       Cfg.Get ("Section_1", "Parameter_12"));
            Log.Info ("Get Parameter_22: " &
                       Cfg.Get ("Section_2", "Parameter_22"));
            Log.Info ("Get Parameter_32: " &
            ...
            Log.Info ("Delete all section_1 parameters. At the");
            Log.Info ("deleting of the last parameter, the");
            Log.Info ("[section_1] line, now useless, is also");
            Log.Info ("deleted");
            ...
            Log.Info ("At the end of the configuration file");
            Log.Info ("demo, only Section_2 and parameter_21");
            Log.Info ("should remain");
            Cfg.Delete ("Section_unknowed", "Parameter_22");
            Cfg.Delete ("Section_2", "Parameter_unknown");
            Cfg.Close;
         end if;

         Log.Info ("Trailing comment preservation test");
