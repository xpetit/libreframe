...
package body LibreFrame.Pdf is
   ...
   ----------------------------------------------------------------------------
   function Get_Size (Object : in out PDF_Out.PDF_Out_File; Str : UString) return Real is
      Char_Width  : Real;
      Result : Real;
   ...
   ----------------------------------------------------------------------------
   function Get_X_Align (Object : in out PDF_Out.PDF_Out_File; X : Real ; Str : UString) return Real is
      Result : Real;
   begin
   ...
   ----------------------------------------------------------------------------
   procedure Put_X_Align (Object : in out PDF_Out.PDF_Out_File; X, Y : Real; Str : UString) is
      Text : Standard.String := To_Latin_1 (Str);
   begin
   ...
   ----------------------------------------------------------------------------
   function Get_X_Right (Object : in out PDF_Out.PDF_Out_File; Right : Real ; Str : UString) return Real is
      Result : Real;
   begin
   ...
   ----------------------------------------------------------------------------
   procedure Put_X_Right (Object : in out PDF_Out.PDF_Out_File; Right, Y : Real; Str : UString) is
      Text : Standard.String := To_Latin_1 (Str);
   begin
   ...
   ----------------------------------------------------------------------------
   function Get_X_Center (Object : in out PDF_Out.PDF_Out_File; Str : UString) return Real is
      Midle_Size : Real;
      Result : Real;
   begin
   ...
   ----------------------------------------------------------------------------
   procedure Put_X_Center (Object : in out PDF_Out.PDF_Out_File; Y : Real; Str : UString) is
      Text : Standard.String := To_Latin_1 (Str);
   begin
   ...
   ----------------------------------------------------------------------------
   procedure Set_Header (Logo_Path, Line_One, Line_Two : UString; Logo_Url : UString := "") is
   begin
   ...
   ----------------------------------------------------------------------------
   procedure Put_Header (Object : in out PDF_Out.PDF_Out_File; Title : UString) is
      Logo_Path : UString := Object_Header.Path_To_Logo ;
      Line_One : UString := Object_Header.First_Line ;
      Line_Two : UString := Object_Header.Second_Line ;
      Logo_Url : UString := Object_Header.Logo_Redirect ;
   begin
      Set_Font (Object);
   ...
   ----------------------------------------------------------------------------
   procedure Set_Footer (Website, Contact, Item : UString := ""; Paginate : Integer := 0) is
   begin
