...
package LibreFrame.Fls is
   ...
   function Delete_Directory_Tree (Dir_Tree : UString) return Boolean;
   procedure Delete_Directory_Tree (Dir_Tree : UString);
   ...
   function Exists (Name : UString) return Boolean;
   --  Returns True if file or directory Name exists.

   function Extract_Directory (Name : UString) return UString;
   --  Returns directory from Name.

   function Extract_Filename (Name : UString) return UString;
   --  Returns filename from Name.

   function File_Size (Name : UString) return Integer;
   --  Size of file

   --  function Get_Directory return String renames AD.Current_Directory;
   function Get_Directory return UString;
   --  Returns the full directory name for the current default directory.

   function If_Root_Directory (Dir_Tree : UString) return Boolean;
   ...
   procedure Move_File (Source_Name, Target_Name : UString);
...
private
   ...
   Copy_Form : constant UString := "preserve=all_attributes,mode=overwrite";
