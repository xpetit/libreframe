...
package LibreFrame.Sys is
   ...
   function Command_Path (Command_Name : UString) return UString;
   ...
   function CRC16_Compute (String_Hex : UString) return Unsigned_16;
   ...
   function Get_Alloc_Ada return UString;
   ...
   function Get_Alloc_All return UString;
   ...
   function Get_Env (Name : UString) return UString;
   --  Returns String value of String or String environment variable Name.

   procedure Set_Env (Name : UString; Value : UString);
   --  Set an environment variable

   function Get_Home return UString;
   --  Returns HOME path.
   ...
   function Is_Command (Command : UString) return Boolean;
   --  Return true if command exists and reachable from path.

   function Is_Package (Package_Name : UString; Host_Name : UString := "") return Boolean;
   --  Return true if Package_Name is installed.

   function Is_Packages (Packages_List : UString; Host_Name : UString := "") return Boolean;
   --  Return true if all packages in Package_List is installed.

   function Install_Packages (Packages_List : UString; Host_Name : UString := "") return Boolean;
   --  Install packages for Debian, Ubuntu or derivatives distributions.

   function Purge_Packages (Packages_List : UString; Host_Name : UString := "") return Boolean;
   --  Install packages for Debian, Ubuntu or derivatives distributions.
   ...
   procedure Set_Memory_Monitor (Enable : Boolean := True);
   ...
   procedure Shell_Execute (Command : UString);
   procedure Shell_Execute (Command : UString; Result : out Integer);
   procedure Shell_Execute (Command : UString; Result : out Integer; Output : out UString);
   ...
   function To_Unsigned_16 (String_In : UString) return Unsigned_16;
   ...
   function To_Unsigned_8 (String_In : UString) return Unsigned_8;
...
private
   ...
   function Install_Package (Package_Name : UString; Host_Name : UString) return Boolean;
   --  Install a Debian or Ubuntu package.

   function Purge_Package (Package_Name : UString; Host_Name : UString) return Boolean;
   --  Purge a Debian or Ubuntu package.

   procedure Shell_Execute_Output (Command : UString; Result : out Integer; Output : out UString);
